  ...
  var Choices = /** @class */ (function () {
    ...
    Choices.prototype._renderChoices = function () {
      ...
      if (activeChoices.length) {
        ...
        if (!this._hasNonChoicePlaceholder && !isSearching && this._isSelectOneElement) {
          ...
          renderChoices(
            activeChoices.filter(function (choice) {
    ...
    Choices.prototype._displayNotice = function (text, type, openDropdown) {
      ...
      if (
        ...
        ((oldNotice.type === type && oldNotice.text === text) ||
          (oldNotice.type === NoticeTypes.addChoice && (type === NoticeTypes.noResults || type === NoticeTypes.noChoices)))
      ) {
        if (openDropdown) {
    ...
    Choices.prototype._handleSearch = function (value) {
      ...
      if (value !== null && typeof value !== 'undefined' && value.length >= this.config.searchFloor) {
        ...
        this._store.choices.some(function (option) {
    ...
    Choices.prototype._addChoice = function (choice, withEvents, userTriggered) {
      ...
      var config = this.config;
      if (
        !config.duplicateItemsAllowed &&
        this._store.choices.find(function (c) {
    ...
    Choices.prototype._addPredefinedChoices = function (choices, selectFirstOption, withEvents) {
      ...
      if (selectFirstOption) {
         ...
         */
        var noSelectedChoices =
          choices.findIndex(function (choice) {
